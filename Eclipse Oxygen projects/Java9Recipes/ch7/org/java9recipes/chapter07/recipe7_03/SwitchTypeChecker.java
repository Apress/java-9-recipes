package org.java9recipes.chapter07.recipe7_03;
...
public class SwitchTypeChecker {
    ...
    public static void main(String[] args) {
        ...
        check.isValidSwitchType(varTypeClass(Integer.valueOf(7)));
        check.isValidSwitchType(varTypeClass("Java 8 Rocks!"));
        check.isValidSwitchType(varTypeClass(Long.valueOf(7)));
