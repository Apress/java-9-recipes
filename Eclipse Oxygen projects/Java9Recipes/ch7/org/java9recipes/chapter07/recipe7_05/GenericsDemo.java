package org.java9recipes.chapter07.recipe7_05;
...
public class GenericsDemo {
    ...
    public static void main(String[] args) {
        ...
        dList.add(Integer.valueOf(5));  // OK
        Number dNum = Double.valueOf(7);
