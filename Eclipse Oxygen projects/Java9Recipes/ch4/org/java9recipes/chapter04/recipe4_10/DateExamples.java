...
package org.java9recipes.chapter04.recipe4_10;
...
public class DateExamples {
    ...
    /**
     * @see <a href="http://download.java.net/java/jdk9/docs/api/java/time/LocalTime.html">LocalTime documentation</a>
     */
    public static void currentTime(){
        ...
        System.out.printf("Hour: %d, Minutes: %d, Nano: %d, Seconds: %d\n", hour, min,nano,sec);
