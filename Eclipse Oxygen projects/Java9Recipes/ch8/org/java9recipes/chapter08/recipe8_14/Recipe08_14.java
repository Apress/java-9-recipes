package org.java9recipes.chapter08.recipe8_14;
...
public class Recipe08_14 {
	public static void printProcessDetails(ProcessHandle currentProcess) {
		...
		System.out.println(
				"Ran for: " + currentProcessInfo.totalCpuDuration().orElse(Duration.ofMillis(0)).toMillis() + "ms");
	...
	public static void main(String[] args) {
		...
		try {
			...
			printProcessDetails(pHandle);
			System.out.println("Parent of Process: " + pHandle.parent());
			printProcessDetails(pHandle.parent().get());
